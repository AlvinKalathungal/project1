...
```{r}
plot_usmap(regions = "counties", data = projectData, values = "cases", include = c("TX")) +  theme_minimal() + scale_fill_continuous(low = "white", high= "red",name = "Total Cases by County", label = scales::comma) + theme(legend.position = "left") + ggtitle("Cases by County in Texas")+ theme(axis.title.x=element_blank(),axis.text.x=element_blank(), axis.ticks.x=element_blank()) + theme(axis.title.y=element_blank(),axis.text.y=element_blank(), axis.ticks.y=element_blank())
```
